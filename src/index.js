 ...
 const pads = [
  {
    ...
    sound: new Audio("https://github.com/jaytomioka/Simon-Says-2/blob/main/assets/simon-says-sound-1.mp3?raw=true"),
  },

  {
    color: "green",
    selector: document.querySelector(".js-pad-green"),
    sound: new Audio("https://github.com/jaytomioka/Simon-Says-2/blob/main/assets/simon-says-sound-2.mp3?raw=true"),
  },

  {
    color: "blue",
    selector: document.querySelector(".js-pad-blue"),
    sound: new Audio("https://github.com/jaytomioka/Simon-Says-2/blob/main/assets/simon-says-sound-3.mp3?raw=true"),
  },

  {
    color: "yellow",
    selector: document.querySelector(".js-pad-yellow"),
    sound: new Audio("https://github.com/jaytomioka/Simon-Says-2/blob/main/assets/simon-says-sound-4.mp3?raw=true"),
  },
 ];
/**
 * EVENT LISTENERS
